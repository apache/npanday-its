...
public class NPandayIT328WPF2010ProjectTest
    extends AbstractNPandayIntegrationTestCase
{
    public NPandayIT328WPF2010ProjectTest()
    {
    ...
    public void testWPF2010Project()
        throws Exception
    {
        File testDir = ResourceExtractor.simpleExtractResources( getClass(), "/WpfApplication8" );
